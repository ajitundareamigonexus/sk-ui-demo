...
export default function HeroDemo6() {
  ...
  return (
    <div id="home-demo4">
      <section className="relative overflow-hidden min-h-[700px] lg:min-h-[600px]">
        ...
        <div className="relative z-30 flex flex-col justify-start lg:justify-center sm:px-6 pt-28 sm:pt-32 lg:pt-36 pb-10 sm:pb-12 lg:pb-16">
          <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col-reverse lg:grid lg:grid-cols-[0.85fr_1.15fr] gap-5 lg:gap-10 items-start w-full">
              ...
              <div
                ...
                className="lg:mr-auto lg:w-full lg:max-w-[540px] lg:min-h-[350px] w-full mt-6 lg:mt-0"
              >
                <BookingTabs variant="demo6" />
              </div>
              ...
              <div className="flex flex-col gap-4 lg:ml-46 w-full items-start text-left">
                ...
                <div className="w-full flex flex-col items-start">
                  ...
                  <span className="font-script text-5xl sm:text-6xl md:text-7xl font-bold text-teal-600 dark:text-teal-400 leading-none block -mt-1 drop-shadow-lg text-left w-full">
                    Travel Happen
                  </span>
        ...
        <div className="relative z-30 hidden sm:block max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 mt-12 mb-8 ">
          <div
            className="rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-4 sm:py-5 px-4 sm:px-6 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4 items-center text-slate-900 dark:text-white shadow-lg"
          ...
          >
            {stats.map((stat, idx) => {
              ...
              return (
                <div
                  key={stat.label}
                  className={`flex items-center gap-2 sm:gap-3 group ${idx < 3 ? 'sm:border-r border-slate-200 dark:border-slate-800 sm:pr-3 lg:pr-4' : ''}`}
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg sm:rounded-xl bg-teal-50 dark:bg-teal-900/30 border border-teal-100 dark:border-teal-800/50 flex items-center justify-center text-teal-600 dark:text-teal-400 shrink-0 shadow-sm group-hover:scale-110 group-hover:bg-teal-100 dark:group-hover:bg-teal-800 group-hover:text-slate-950 transition-all duration-200">
                    <Icon className="w-4 h-4 sm:w-5 sm:h-5 stroke-[2.2]" />
                  </div>
                  <div>
                    <div className="text-lg sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight leading-none">
                      {stat.value}
                    </div>
                    <div className="text-[10px] sm:text-sm font-medium text-slate-500 tracking-wide mt-0.5">
                      {stat.label}
                    </div>
                  </div>
                </div>
            ...
            {/* Quote */}
            <div className="col-span-2 sm:col-span-4 lg:col-span-1 flex items-center justify-center border-t sm:border-t-0 lg:border-l border-slate-200 dark:border-slate-800 pt-2.5 sm:pt-0 lg:pl-4">
              <div className="flex items-center gap-1.5 text-center">
                <span className="text-amber-400 text-2xl sm:text-4xl font-serif leading-none select-none">&ldquo;</span>
                <p className="font-script text-base sm:text-xl font-bold text-slate-900 dark:text-white leading-tight">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between">
                      ...
                      <div className="w-7 h-7 rounded-full bg-white/90 text-slate-900 flex items-center justify-center group-hover:bg-teal-100 dark:group-hover:bg-teal-800 group-hover:text-black transition-colors shrink-0 shadow-sm text-xs font-bold ml-2">
                        →
                      </div>
                    </div>
                  </div>
